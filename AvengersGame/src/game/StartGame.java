...
public class StartGame extends JFrame implements ActionListener {
	...
	public StartGame(String guest, String characterChoosed) {
		...
		StaticSemaphore.lifeUser.setBounds(150,20, 100, 20);
		StaticSemaphore.lifeUser.setVisible(true);
		StaticSemaphore.lifeUser.setForeground(Color.RED);
		this.add(StaticSemaphore.lifeUser);
		StaticSemaphore.lifeEnemy.setBounds(650,20, 100, 20);
		StaticSemaphore.lifeEnemy.setVisible(true);
		StaticSemaphore.lifeEnemy.setForeground(Color.RED);
		this.add(StaticSemaphore.lifeEnemy);
